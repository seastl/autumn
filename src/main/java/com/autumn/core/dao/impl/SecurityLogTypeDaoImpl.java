...
public class SecurityLogTypeDaoImpl implements SecurityLogTypeDao {
  ...
  public List<SecurityLogType> getSecuritiesForIntraDay() {
    ...
    security = new SecurityLogType(new Security(10, "Alcoa", "AA", SecurityType.US_STOCK, Sector.INDUSTRIAL, true, "s2000@9.561"),
                                   ...
                                   Boolean.TRUE);
    securities.add(security);
    security = new SecurityLogType(new Security(11, "Chevron", "CVX", SecurityType.US_STOCK, Sector.MATERIALS, true, "b200@77.14, b200@101.93"),
                                   new LogType(LogType.INTRA_DAY_LOG_ALWAYS, "Intra day log - always", 0F, -0F, Time.valueOf("06:00:00"), Time.valueOf("13:05:00")),
                                   Boolean.TRUE);
    securities.add(security);
    ...
    security = new SecurityLogType(new Security(13, "Intel", "INTC", SecurityType.US_STOCK, Sector.TECHNOLOGY, true, "s200@32.50"),
                                   ...
                                   Boolean.TRUE);
    securities.add(security);
    security = new SecurityLogType(new Security(14, "HP", "HPQ", SecurityType.US_STOCK, Sector.TECHNOLOGY, true, "b1000@9.61, b590@12.38"),
                                   new LogType(LogType.INTRA_DAY_LOG_ALWAYS, "Intra day log - always", 0F, -0F, Time.valueOf("06:00:00"), Time.valueOf("13:05:00")),
                                   Boolean.TRUE);
    securities.add(security);
    ...
    security = new SecurityLogType(new Security(17, "Tableau", "DATA", SecurityType.US_STOCK, Sector.TECHNOLOGY, true, "b100@39.34"),
                                   ...
                                   Boolean.TRUE);
    securities.add(security);
    security = new SecurityLogType(new Security(18, "Micron", "MU", SecurityType.US_STOCK, Sector.TECHNOLOGY, true, "b1000@12.32"),
                                   new LogType(LogType.INTRA_DAY_LOG_ALWAYS, "Intra day log - always", 0F, -0F, Time.valueOf("06:00:00"), Time.valueOf("13:05:00")),
                                   Boolean.TRUE);
    securities.add(security);
    security = new SecurityLogType(new Security(19, "Catapila", "CAT", SecurityType.US_STOCK, Sector.INDUSTRIAL, true, "b100@77.29, b100@73.63"),
                                   new LogType(LogType.INTRA_DAY_LOG_ALWAYS, "Intra day log - always", 0F, -0F, Time.valueOf("06:00:00"), Time.valueOf("13:05:00")),
                                   Boolean.TRUE);
    securities.add(security);
  ...
  public List<SecurityLogType> getSecuritiesForDow30() {
    ...
    security = new SecurityLogType(new Security(1806, "", "BA", SecurityType.US_STOCK, Sector.INDUSTRIAL),
                                   ...
                                   Boolean.TRUE);
    securities.add(security);
    security = new SecurityLogType(new Security(1807, "", "CAT", SecurityType.US_STOCK, Sector.INDUSTRIAL, true, "b100@77.29, b100@73.63"),
                                   new LogType(LogType.END_DAY_LOG, "Start of day log", null, null, null, Time.valueOf("13:05:00")),
                                   Boolean.TRUE);
    securities.add(security);
